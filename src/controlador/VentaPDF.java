...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            Image img = Image.getInstance("src/img/Fondo_Cava_Dorada-removebg-preview_1.png");
            ...
            String ruc = "20602096727";
            String nombre = "Grupo La Cava Dorada";
            String telefono = "992237848";
            String direccion = "Calle Falsa 123, Ciudad Ficticia” ICA";
            ...
            info.add("Total a pagar: S/ " + InterFacturacion.txt_total_pagar.getText());
